...
public class Server {
    ...
    private UserService userService = new UserService(user, auth);
    private GameService gameService = new GameService(game, auth);
    private ClearService clearService = new ClearService(user, game, auth);
    ...
    public Object listGamesHandler(Request req, Response res) {
        try {
            ...
            res.status(200);
            System.out.println(new Gson().toJson(listGames));
